...
import (
	...
	tcsv1alpha2 "github.com/intel-innersource/applications.services.cloud.hsm-sds-server/pkg/apis/tcs/v1alpha2"
	...
	v1alpha2 "github.com/intel-innersource/applications.services.cloud.hsm-sds-server/pkg/client/listers/tcs/v1alpha2"
...
type QuoteAttestationInformer interface {
	...
	Lister() v1alpha2.QuoteAttestationLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TcsV1alpha2().QuoteAttestations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TcsV1alpha2().QuoteAttestations(namespace).Watch(context.TODO(), options)
			},
		},
		&tcsv1alpha2.QuoteAttestation{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *quoteAttestationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&tcsv1alpha2.QuoteAttestation{}, f.defaultInformer)
}

func (f *quoteAttestationInformer) Lister() v1alpha2.QuoteAttestationLister {
	return v1alpha2.NewQuoteAttestationLister(f.Informer().GetIndexer())
}
