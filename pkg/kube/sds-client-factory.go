...
// newSDSClientFactory creates a new util.Factory from the given clientcmd.ClientConfig.
func newSDSClientFactory(clientConfig clientcmd.ClientConfig, diskCache bool) *clientFactory {
	out := &clientFactory{
